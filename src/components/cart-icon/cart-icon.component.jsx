...
//Maps the result of the selectCartItemsCount selector to the itemCount props of this component, selectCartItemsCount calculates the quantity of items in the cart
